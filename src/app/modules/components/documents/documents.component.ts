...
// { name: 'Project Plan.Risk register', url: '/assets/documents/Project Plan.Risk register.xlsx', size: '13 KB',  type: 'excel' },
  ...
  { name: 'Business Process Reengineering Company Profile', url: 'src/assets/documents/Polarsigma_Company_Profile.xlsx', link:'https://docs.google.com/spreadsheets/d/1Cq4MBbqFIbK2LSOzuIPFFruNzJUXkOvG/edit?usp=drive_link&ouid=100551018059674000700&rtpof=true&sd=true',  size: '16 KB' ,  type: 'excel', description : 'Polarsigma Consulting: Established in 2010 and headquartered in Lagos, Nigeria, Polarsigma specializes in business process reengineering, workflow optimization, and innovative solutions across industries such as healthcare, finance, retail, manufacturing, and technology' },
